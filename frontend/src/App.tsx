        ...
        {serviceHelpOpen && (
          <div className="help-popup help-popup--service">
            ...
            <ul className="help-popup__list">
              <li><strong>Проверяется:</strong> текст разделов — стиль, формулировки, научный язык; таблицы (преобразуются в текст при конвертации).</li>
              <li><strong>Не проверяется:</strong> рисунки и другое графическое содержимое.</li>
