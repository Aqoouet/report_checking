...
- `PROMPT_PRESET` — стиль проверки: `default`, `formal` или `short` (файлы в `backend/prompts/`); при необходимости отредактируйте `.txt` на сервере — подхватится на следующей странице без пересборки
