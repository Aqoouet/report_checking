...
2. Для каждого упоминания оцени: не противоречит ли то, что утверждается о таблице/рисунке
   в тексте, тому, о чём говорит caption?
   Сравни тему/содержимое, заявленное в тексте, с темой, указанной в подписи.
   Пример ошибки: caption — «Таблица 5.1 — Данные о ремонте», а в тексте написано
   «таблица содержит данные об овощах и фруктах» — явное противоречие, это ошибка.
   Если тема упоминания совпадает или нейтральна (просто ссылка без описания содержимого) — ошибки нет.
